                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-8">
                      {displayedVehicles.map((v) => (
                        <div key={v.id} className={`rounded-xl md:rounded-3xl overflow-hidden group transition-all duration-300 relative ${v.driverVipStars >= 5
                          ? "bg-gradient-to-br from-amber-500/10 to-card-bg border-2 border-amber-500/50 shadow-lg shadow-amber-500/10 hover:shadow-2xl hover:shadow-amber-500/30 hover:-translate-y-1"
                          : v.driverVipStars === 4
                            ? "bg-gradient-to-br from-blue-500/10 to-card-bg border-2 border-blue-500/40 shadow-md shadow-blue-500/10 hover:shadow-xl hover:shadow-blue-500/20 hover:-translate-y-1"
                            : "glass-panel hover:shadow-xl hover:shadow-brand-secondary/10 hover:-translate-y-1"
                          }`}>
                          {v.driverVipStars >= 5 && (
                          ...
                          <div className="px-2 py-3 md:p-5 flex-1 flex flex-col">
                            ...
                            <div className="flex flex-wrap items-center gap-x-0.5 md:gap-x-2 gap-y-1 text-[11px] md:text-xs text-foreground/70 font-medium mb-2">
