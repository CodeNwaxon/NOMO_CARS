...
export default function SiteSettingsPage() {
  ...
  const addSocial = () => setSiteConfig({ ...siteConfig, socials: [...siteConfig.socials, { platform: "facebook", url: "" }] });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-4 pb-28 px-3 md:px-8 relative overflow-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Tabs Navigation */}
        <div className="flex bg-white dark:bg-gray-800 p-1.5 rounded-lg mb-6 overflow-x-auto no-scrollbar shadow-sm border border-gray-100 dark:border-gray-700">
          {(["global", "about", "faq", "policy", "socials"] as Tab[]).map((tab) => (
            <button
              key={tab}
              onClick={() => setActiveTab(tab)}
              className={`px-4 py-2 md:px-5 md:py-2.5 rounded-md text-xs md:text-sm font-semibold transition-all whitespace-nowrap capitalize ${
                activeTab === tab
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input 
                        ...
                        className="flex-1 p-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-brand-primary outline-none" 
                        placeholder="https://..."
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-5 rounded-2xl border border-gray-100 dark:border-gray-800">
                      ...
                      <div className="flex gap-2 mb-4">
                        ...
                        <button onClick={() => driverImageInputRef.current?.click()} className="px-3 bg-gray-200 dark:bg-gray-700 rounded-lg text-sm font-medium">Up</button>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-5 rounded-2xl border border-gray-100 dark:border-gray-800">
                      ...
                      <div className="flex gap-2 mb-4">
                        ...
                        <button onClick={() => passengerImageInputRef.current?.click()} className="px-3 bg-gray-200 dark:bg-gray-700 rounded-lg text-sm font-medium">Up</button>
          ...
          {activeTab === "faq" && (
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              {faqConfig.map((faq, idx) => (
                <div key={idx} className="bg-gray-50 dark:bg-gray-900/50 p-5 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
          ...
          {activeTab === "policy" && (
            <div className="space-y-6 animate-in fade-in duration-300">
              <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-700 pb-4 mb-4">
                ...
                <button onClick={addPolicy} className="flex items-center gap-2 px-4 py-2 bg-brand-primary text-white rounded-lg text-sm font-semibold hover:bg-brand-primary/90 transition-colors">
                  <Plus className="w-4 h-4" /> Add Policy Section
                </button>
              </div>

              {policyConfig.map((policy, pIdx) => (
                <div key={pIdx} className="bg-gray-50 dark:bg-gray-900/50 p-5 rounded-2xl border border-gray-200 dark:border-gray-700 relative">
          ...
          <div className="max-w-3xl mx-auto bg-gray-900 dark:bg-white text-white dark:text-gray-900 p-4 rounded-2xl shadow-2xl flex flex-col md:flex-row items-center justify-between gap-4 pointer-events-auto border border-white/10 dark:border-black/10 animate-in slide-in-from-bottom-10 fade-in duration-300">
            ...
            <div className="flex gap-3 w-full md:w-auto">
              <button 
                ...
                className="flex-1 md:flex-none px-6 py-2.5 bg-white/10 dark:bg-black/5 hover:bg-white/20 dark:hover:bg-black/10 rounded-xl font-semibold transition-colors"
              >
                Discard
              </button>
              <button 
                onClick={handleSaveInitiate}
                className="flex-1 md:flex-none px-6 py-2.5 bg-brand-primary text-white rounded-xl font-bold hover:bg-brand-primary/90 transition-colors shadow-lg shadow-brand-primary/20"
              >
                Save Changes
              </button>
            </div>
