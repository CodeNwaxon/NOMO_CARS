    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 p-4 md:p-8">
      ...
      {!singleMode && images.length > 1 && (
        <>
          <button 
            onClick={handlePrev}
            className="flex absolute left-2 md:left-6 z-[110] p-1.5 md:p-3 bg-black/50 md:bg-white/10 hover:bg-black/70 md:hover:bg-white/20 rounded-full text-white backdrop-blur-sm transition-colors"
          >
          ...
          <button 
            onClick={handleNext}
            className="flex absolute right-2 md:right-6 z-[110] p-1.5 md:p-3 bg-black/50 md:bg-white/10 hover:bg-black/70 md:hover:bg-white/20 rounded-full text-white backdrop-blur-sm transition-colors"
          >
